...
async function testOutlook2() {
  console.log("Testing PLAIN TEXT email to Outlook\n");

  // Use Roberts Co - Australian builder
  const testLead = {
    companyName: "Roberts Co",
    contactName: "Jayson",
    contactEmail: "jaysonryan21@hotmail.com",
    website: "https://www.robertsco.com.au",
  ...
  console.log("1. Creating lead for Roberts Co...");
  ...
  console.log("\nCheck Outlook inbox - this is now PURE PLAIN TEXT");
}

testOutlook2().catch(console.error);
